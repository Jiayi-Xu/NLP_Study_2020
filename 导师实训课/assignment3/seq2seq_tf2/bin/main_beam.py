...
def main():
    ...
    # train数据report有很多step为2的结果-"随时联系"
    parser.add_argument("--min_dec_steps", default=2,
    ...
    parser.add_argument("--test_x_dir", default='{}/datasets/AutoMaster_TestSet_10.csv'.format(BASE_DIR), help="test_x_dir")
    ...
    参数 greedy_decode:
        为True时 贪心搜索
        为False时 为 beam search
    """
    parser.add_argument("--greedy_decode", default=False, help="greedy_decoder")

    # 预测时候设置sample_size， 本地测试时候设置为3 全量为20000
    parser.add_argument("--sample_size", default=10, help="sample_size")
    # parser.add_argument("--beam_result_save_path", default='{}/datasets/'.format(BASE_DIR), help="beam_result_save_path")
